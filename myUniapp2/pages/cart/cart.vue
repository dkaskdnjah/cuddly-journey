<template>
	<view>
		<view class="bg-fff flex padding-sm" v-for="(item, index) in cartList">
			<view class="">
			...
			<view class="overlayContent bg-fff margin" @click.stop v-if="show">
				<view class="padding">
					...
					<view class="flex justify-between padding-tb u-border-bottom">
						规格选择
						<view class="flex handleshowDraw" @click="drawShow = true">
				...
				<view class="">
					<button type="default" class="myBtn cu-btn bg-brown">取消</button>
					<button type="default" class="myBtn cu-btn bg-yellow">确定</button>
				</view>
			</view>
		</u-overlay>
